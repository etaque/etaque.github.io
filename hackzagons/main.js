...
Elm.Constant = Elm.Constant || {};
Elm.Constant.Color = Elm.Constant.Color || {};
Elm.Constant.Color.make = function (_elm) {
   "use strict";
   _elm.Constant = _elm.Constant || {};
   _elm.Constant.Color = _elm.Constant.Color || {};
   if (_elm.Constant.Color.values)
   return _elm.Constant.Color.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Constant.Color",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var player = "rgb(200, 130, 170)";
   var collisionTile = "rgb(200, 230, 180)";
   var rockTile = "rgb(160, 146, 159)";
   var sandTile = "rgb(242, 243, 196)";
   var title = "rgb(255, 255, 255)";
   var background = "rgb(147,202,223)";
   _elm.Constant.Color.values = {_op: _op
...
Elm.Constant = Elm.Constant || {};
Elm.Constant.Size = Elm.Constant.Size || {};
Elm.Constant.Size.make = function (_elm) {
   "use strict";
   _elm.Constant = _elm.Constant || {};
   _elm.Constant.Size = _elm.Constant.Size || {};
   if (_elm.Constant.Size.values)
   return _elm.Constant.Size.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Constant.Size",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   var title = 30;
   var boardHeight = 500;
   var tilesCenterY = boardHeight / 2;
   var boardWidth = 1000;
   var tilesCenterX = boardWidth / 2;
   _elm.Constant.Size.values = {_op: _op
                               ,boardWidth: boardWidth
                               ,boardHeight: boardHeight
                               ,tilesCenterX: tilesCenterX
                               ,tilesCenterY: tilesCenterY
                               ,title: title
...
Elm.Model.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Model$Coords = Elm.Model.Coords.make(_elm),
   $Model$Position = Elm.Model.Position.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var Rock = {ctor: "Rock"};
   var rockTile = function (coords) {
      return {_: {}
             ,coords: coords
             ,kind: Rock};
   };
   var Sand = {ctor: "Sand"};
   var sandTile = function (coords) {
      return {_: {}
             ,coords: coords
             ,kind: Sand};
   };
...
Elm.Model = Elm.Model || {};
Elm.Model.Collision = Elm.Model.Collision || {};
Elm.Model.Collision.make = function (_elm) {
   "use strict";
   _elm.Model = _elm.Model || {};
   _elm.Model.Collision = _elm.Model.Collision || {};
   if (_elm.Model.Collision.values)
   return _elm.Model.Collision.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Model.Collision",
   $Basics = Elm.Basics.make(_elm),
   $Constant$Size = Elm.Constant.Size.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Model$Position = Elm.Model.Position.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var playerTileCollision = F2(function (playerPos,
   tilePos) {
      return _U.cmp(A2($Model$Position.distance,
      playerPos,
      tilePos),
      $Constant$Size.playerRadius + $Constant$Size.tileRadius) < 0;
   });
   _elm.Model.Collision.values = {_op: _op
                                 ,playerTileCollision: playerTileCollision};
   return _elm.Model.Collision.values;
};
Elm.Model = Elm.Model || {};
Elm.Model.Coords = Elm.Model.Coords || {};
Elm.Model.Coords.make = function (_elm) {
   "use strict";
   _elm.Model = _elm.Model || {};
   _elm.Model.Coords = _elm.Model.Coords || {};
   if (_elm.Model.Coords.values)
   return _elm.Model.Coords.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Model.Coords",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   _elm.Model.Coords.values = {_op: _op
                              ,Coords: Coords};
   return _elm.Model.Coords.values;
};
Elm.Model = Elm.Model || {};
Elm.Model.Hexagon = Elm.Model.Hexagon || {};
Elm.Model.Hexagon.make = function (_elm) {
   "use strict";
   _elm.Model = _elm.Model || {};
   _elm.Model.Hexagon = _elm.Model.Hexagon || {};
   if (_elm.Model.Hexagon.values)
   return _elm.Model.Hexagon.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Model.Hexagon",
   $Basics = Elm.Basics.make(_elm),
   $Constant$Size = Elm.Constant.Size.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var getTilePosition = function (coords) {
      return function () {
         var dist = 1.725 * $Constant$Size.tileRadius;
         return {_: {}
                ,x: $Constant$Size.tilesCenterX + dist * ($Basics.toFloat(coords.x) + $Basics.toFloat(coords.y) * $Basics.cos($Basics.degrees(60.0)))
                ,y: $Constant$Size.tilesCenterY + dist * $Basics.toFloat(coords.y) * $Basics.sin($Basics.degrees(60.0))};
      }();
   };
   _elm.Model.Hexagon.values = {_op: _op
                               ,getTilePosition: getTilePosition};
   return _elm.Model.Hexagon.values;
};
Elm.Model = Elm.Model || {};
Elm.Model.Position = Elm.Model.Position || {};
Elm.Model.Position.make = function (_elm) {
   "use strict";
   _elm.Model = _elm.Model || {};
   _elm.Model.Position = _elm.Model.Position || {};
   if (_elm.Model.Position.values)
   return _elm.Model.Position.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Model.Position",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   p2) {
      return $Basics.sqrt(Math.pow(p2.x - p1.x,
      2) + Math.pow(p2.y - p1.y,2));
   });
   var Position = F2(function (a,
   b) {
      return {_: {},x: a,y: b};
   });
   _elm.Model.Position.values = {_op: _op
                                ,distance: distance
                                ,Position: Position};
   return _elm.Model.Position.values;
};
...
Elm.Update.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var updatePosition = F2(function (a,
   p) {
      return {_: {}
             ,x: A3($Basics.clamp,
             $Constant$Size.playerRadius,
             $Constant$Size.boardWidth - $Constant$Size.playerRadius,
             p.x + 2 * $Basics.toFloat(a.x))
             ,y: A3($Basics.clamp,
             $Constant$Size.playerRadius,
             $Constant$Size.boardHeight - $Constant$Size.playerRadius,
             p.y - 2 * $Basics.toFloat(a.y))};
   });
   var update = F2(function (_v0,
   map) {
      return function () {
         return function () {
            var newPosition = A2(updatePosition,
            _v0.arrows,
            map.position);
...
Elm.View.make = function (_elm) {
   ...
   $moduleName = "View",
   $Basics = Elm.Basics.make(_elm),
   $Constant$Color = Elm.Constant.Color.make(_elm),
   $Constant$Size = Elm.Constant.Size.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Model = Elm.Model.make(_elm),
   $Model$Collision = Elm.Model.Collision.make(_elm),
   $Model$Hexagon = Elm.Model.Hexagon.make(_elm),
   $Model$Position = Elm.Model.Position.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Svg = Elm.Svg.make(_elm),
   $Svg$Attributes = Elm.Svg.Attributes.make(_elm),
   $View$Hexagon = Elm.View.Hexagon.make(_elm);
   var player = function (_v0) {
      return function () {
         return A2($Svg.circle,
         _L.fromArray([$Svg$Attributes.cx($Basics.toString(_v0.x))
                      ,$Svg$Attributes.cy($Basics.toString(_v0.y))
                      ,$Svg$Attributes.r($Basics.toString($Constant$Size.playerRadius))
                      ,$Svg$Attributes.stroke("white")
                      ,$Svg$Attributes.strokeWidth("2")
                      ,$Svg$Attributes.fill($Constant$Color.player)]),
         _L.fromArray([]));
      }();
   };
   var hexagon = F3(function (playerPos,
   kind,
   tilePos) {
      return function () {
         var bg = A2($Model$Collision.playerTileCollision,
         playerPos,
         tilePos) ? $Constant$Color.collisionTile : function () {
            switch (kind.ctor)
            {case "Rock":
               return $Constant$Color.rockTile;
               case "Sand":
               return $Constant$Color.sandTile;}
            _U.badCase($moduleName,
            "between lines 91 and 94");
         }();
         var hexagonPoints = $View$Hexagon.toSvgPoints($View$Hexagon.corners(tilePos));
         return A2($Svg.polygon,
         _L.fromArray([$Svg$Attributes.fill(bg)
                      ,$Svg$Attributes.points(hexagonPoints)]),
         _L.fromArray([]));
      }();
   });
   var hexagons = function (map) {
      return A2($List.map,
      function (tile) {
         return A3(hexagon,
         map.position,
         tile.kind,
         $Model$Hexagon.getTilePosition(tile.coords));
      },
      map.tiles);
   };
   var title = A2($Svg.text$,
   _L.fromArray([$Svg$Attributes.x("5")
                ,$Svg$Attributes.y($Basics.toString($Constant$Size.title + 5))
                ,$Svg$Attributes.fill($Constant$Color.title)
                ,$Svg$Attributes.fontSize($Basics.toString($Constant$Size.title))]),
   _L.fromArray([$Svg.text("Hackzagons")]));
   var background = function (_v3) {
      return function () {
         switch (_v3.ctor)
         {case "_Tuple2":
            return A2($Svg.rect,
              _L.fromArray([$Svg$Attributes.width($Basics.toString(_v3._0))
                           ,$Svg$Attributes.height($Basics.toString(_v3._1))
                           ,$Svg$Attributes.fill($Constant$Color.background)]),
              _L.fromArray([]));}
         _U.badCase($moduleName,
         "between lines 57 and 62");
      }();
   };
   var tilePattern = F4(function (pid,
   w,
   h,
   url) {
      return A2($Svg.pattern,
      _L.fromArray([$Svg$Attributes.id(pid)
                   ,$Svg$Attributes.width($Basics.toString(w))
                   ,$Svg$Attributes.height($Basics.toString(h))
                   ,$Svg$Attributes.patternUnits("userSpaceOnUser")]),
      _L.fromArray([A2($Svg.image,
   ...
   var appDefs = A2($Svg.defs,
   _L.fromArray([]),
   _L.fromArray([A4(tilePattern,
   "sandPattern",
   360,
   360,
   "http://cdn.grid.fotosearch.com/CSP/CSP428/k4284340.jpg")]));
   var board = function (map) {
      return A2($Svg.svg,
      _L.fromArray([$Svg$Attributes.width("100%")
                   ,$Svg$Attributes.height("100%")]),
      A2($Basics._op["++"],
      _L.fromArray([appDefs,title]),
      A2($Basics._op["++"],
      hexagons(map),
      _L.fromArray([player(map.position)]))));
   };
...
Elm.View = Elm.View || {};
Elm.View.Hexagon = Elm.View.Hexagon || {};
Elm.View.Hexagon.make = function (_elm) {
   "use strict";
   _elm.View = _elm.View || {};
   _elm.View.Hexagon = _elm.View.Hexagon || {};
   if (_elm.View.Hexagon.values)
   return _elm.View.Hexagon.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "View.Hexagon",
   $Basics = Elm.Basics.make(_elm),
   $Constant$Size = Elm.Constant.Size.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var toSvgPoints = function (points) {
      return $String.join(" ")($List.map(function (_v0) {
         return function () {
            ...
            $Basics.toString(_v0.x),
            A2($Basics._op["++"],
            ",",
            $Basics.toString(_v0.y)));
         }();
      })(points));
   };
   var corner = F2(function (center,
   i) {
      return function () {
         var angle = $Basics.degrees(60 * $Basics.toFloat(i) + 30);
         return {_: {}
                ,x: center.x + $Constant$Size.tileRadius * $Basics.cos(angle)
                ,y: center.y + $Constant$Size.tileRadius * $Basics.sin(angle)};
      }();
   });
   var corners = function (center) {
      return A2($List.map,
      corner(center),
      _L.range(0,5));
   };
   _elm.View.Hexagon.values = {_op: _op
                              ,corners: corners
